...
define config.name = _("Молчание коммунальных квартир")
...
Эта игра презирает грязный капитализм и является бесплатной.

Автор игры: Chudi-mortis 

Группа автора вк: https://vk.com/chudimortis

Группа игры вк: https://vk.com/molchaniekommunalnihkvartir

Хэштег в вк и твиттере: #МолчаниеКоммунальныхКвартир

Автор музыки: Da Voile

Группа Da Voile вк: https://vk.com/da_voile

Музыка в радио: Blue Suede Shoes - Elvis Presley

Авторы фото, использовавшихся для фонов:

alexdoomer

kadavra

...и другие, чьих контактов найти не удалось.
...
define config.main_menu_music = "audio/main_menu_theme.ogg"
...
define config.save_directory = "MKKR-1676708668"
